                        ...
                        <div class="wishlist-table table-responsive">
                            <table>
                                ...
                                <tbody>
                                    ...
                                    /* $res = mysqli_query($conn, "SELECT `order`.*,product.name,order_status.name as order_status_str from `order`,order_status,product,`order_detail` where `order`.user_id='$uid' and order_status.id=`order`.order_status and product.id=`order_detail`.product_id ");
                                    ...
                                    while ($row = mysqli_fetch_assoc($res)) {
                                        $service_status_checker = $row['order_status_str'];
                                        
                                        if ($service_status_checker == 'Complete') {
                                    ?>
                                            <tr>
                                                <td class="product-add-to-cart"><a href="my_order_details.php?id=<?php echo $row['id'] ?>"> <?php echo 'MY ORDER' ?></a>
                                                    <br />

                                                    <a href="pdf.php?id=<?php echo $row['id'] ?>"> PDF</a><br />
                                                    <a href="review.php?id=<?php echo $row['id'] ?>"> Review</a>
                                                </td>
                                            <?php
                                        } else {
                                            ?>
