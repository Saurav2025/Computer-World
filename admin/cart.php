...
require('top.inc.php');
?>
<div class="ht__bradcaump__area" style="background: rgba(0, 0, 0, 0) url(images/9.webp) no-repeat scroll center center / cover ;">
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td class="product-remove"><a href="javascript:void(0)" onclick="manage_cart_del('<?php echo $key ?>','remove')"><i class="icon-trash icons"></i></a></td>
                                        </tr>
                                <?php }
                                } ?>
                            </tbody>
