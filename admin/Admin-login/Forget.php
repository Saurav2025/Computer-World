...
if (isset($_POST['submit'])) {
	...
	if ($emailcount) {
		...
		$html = 'Hi,' . $username . ', We heard You just forgotten your passowrd.No worries we are here to help you out. Click here to Reset your password http://localhost/admin/Admin-login/Reset.php?token=' . $token . '';
