                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="product-stock-stauts"><span class="nobr"> User Name </span></th>
                                ...
                                <tbody>
                                    <?php
                                    $res = mysqli_query($conn, "SELECT `order`.*,order_status.name as order_status_str from `order`,order_status where order_status.id=`order`.order_status order by `order`.id desc");
                                    while ($row = mysqli_fetch_assoc($res)) {
                                    ?>
                                        <tr>
                                            <td class="product-add-to-cart"><a href="order_master_detail.php?id=<?php echo $row['id'] ?>"> <?php echo $row['id'] ?></a><br />
                                                <a href="../pdf.php?id=<?php echo $row['id'] ?>">PDF</a>
                                                </td>
                                            </td>
