...
$meta_title = "ComputerWorld";
$meta_desc = "ComputerWorld";
$meta_keyword = "ComputerWorld";
$meta_url = SITE_PATH;
$meta_image = "";
...
<head>
    ...
    <link rel="stylesheet" href="Saurav.css">
    <link rel="stylesheet" href="css/responsive.css">
    <link rel="stylesheet" href="css/custom.css">
    <script src="js/vendor/modernizr-3.5.0.min.js"></script>
    <style>
        .wrapper.sticky-header-with-topbar {
                    ...
                    <div class="row">
                        <div class="menumenu__container clearfix">
                            <div class="col-lg-2 col-md-2 col-sm-3 col-xs-5">
                                <div class="logo">
                                    <a href="index.php"><img src="images/logo/Comp1.png" alt="logo images"></a>
                                </div>
                            </div>
                                ...
                                <div class="mobile-menu clearfix visible-xs visible-sm">
                                    <nav id="mobile_dropdown">
                                        <ul>
                                            ...
                                            ?>
                                                <li><a href="profile.php">Hi,<?php echo $_SESSION['USER_NAME'] ?></a></li>
                                                <li><a href="my_order.php">Order</a></li>
                                                <li><a href="my_service.php">Service</a></li>
                            ...
                            <div class="col-md-3 col-lg-4 col-sm-4 col-xs-4">
                                <div class="header__right">
                                    ...
                                    <div class="header__account">
                                        <?php if (isset($_SESSION['USER_LOGIN'])) {
                                        ?>
                                            <nav class="navbar navbar-expand-lg navbar-light bg-light" style="padding-top: 25px;">
                                                ...
                                                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                                    <ul class="navbar-nav mr-auto">
                                                        <li class="nav-item dropdown">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="navbarDropdown" style="padding-top: 14px;">
                                                                <a class="dropdown-item" href="my_order.php">Order</a>
                                                                <a class="dropdown-item" href="my_service.php">Service</a>
                                        ...
                                        <?php
                                            ...
                                            echo '<a href="../Computer_world/Login.php"" class="mr15">Login/Register</a>';
                                        }
                                        ?>
                                    </div>
                            ...
                            <ul class="navbar-nav mr-auto">
                                ...
                                ?>
                                    <li class="" style="display:inline;">
                                        <a class="nav-link dropdown-toggle" style="margin: 10px;color:solid-black;font-weight: 700;text-transform: uppercase;" href="categories.php?id=<?php echo $list['id'] ?>" id="navbarDropdown" role="button" data-toggle="dropdown">
                                        ...
                                        ?>
                                            <div class="dropdown-menu" aria-labelledby="navbarDropdown" style="padding-top: 14px;">
                                                <?php
                                                while ($sub_cat_rows = mysqli_fetch_assoc($sub_cat_res)) {
                                                    echo '<a class="dropdown-item"style="width: 90%;padding: 1em 5%;font-weight: 700;margin: 0;text-align: left;color:black;border-top: 1px solid #383838;border-top: 1px solid rgba(255,255,255,0.2);text-transform: uppercase;" href="categories.php?id=' . $list['id'] . '&sub_categories=' . $sub_cat_rows['id'] . '">' . $sub_cat_rows['sub_categories'] . '</a></br>';
                                                }
                                                ?>
