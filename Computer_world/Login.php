			...
			<div class="signin-signup">
				...
				<form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" class="sign-up-form" method="post">
					...
					<div class="input-field">
						...
						<input type="tel" placeholder="Phone Number" name="phone" value="<?php echo $_POST["phone"]; ?>" maxlength="10"  required />
					</div>
					<div class="input-field">
						<span toggle="#psw" id="icon" class="fas fa-eye-slash field-icon toggle-password fa-4x"></span>
						<input type="password" id="psw" name="psw"  placeholder="Enter Your password"maxlength="20" minlength="8" value="<?php echo $_POST["psw"]; ?>" required>
